...
.text
.protected Cijk_Alik_Bljk_HHS_BH_UserArgs_MT32x32x32_MI16x16x1_SN_DTVA1_K1_LBSPPA0_LPA0_MIWT2_1_VWB1_WG16_8_1
.globl Cijk_Alik_Bljk_HHS_BH_UserArgs_MT32x32x32_MI16x16x1_SN_DTVA1_K1_LBSPPA0_LPA0_MIWT2_1_VWB1_WG16_8_1
.p2align 8
.type Cijk_Alik_Bljk_HHS_BH_UserArgs_MT32x32x32_MI16x16x1_SN_DTVA1_K1_LBSPPA0_LPA0_MIWT2_1_VWB1_WG16_8_1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Alik_Bljk_HHS_BH_UserArgs_MT32x32x32_MI16x16x1_SN_DTVA1_K1_LBSPPA0_LPA0_MIWT2_1_VWB1_WG16_8_1
...
amdhsa.version:
  ...
  - 1
amdhsa.kernels:
  - .name: Cijk_Alik_Bljk_HHS_BH_UserArgs_MT32x32x32_MI16x16x1_SN_DTVA1_K1_LBSPPA0_LPA0_MIWT2_1_VWB1_WG16_8_1
    .symbol: 'Cijk_Alik_Bljk_HHS_BH_UserArgs_MT32x32x32_MI16x16x1_SN_DTVA1_K1_LBSPPA0_LPA0_MIWT2_1_VWB1_WG16_8_1.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Cijk_Alik_Bljk_HHS_BH_UserArgs_MT32x32x32_MI16x16x1_SN_DTVA1_K1_LBSPPA0_LPA0_MIWT2_1_VWB1_WG16_8_1:
...
v_lshrrev_b32 v30, 6, v[vgprSerial]                // 7. wave offset in N dimen: wtid = tid / dividedForWaveId(64)
v_and_b32 v30, 1, v30                              // 7. wave offset in M dimen: wtid0 = wtid / num1DWaves(2)
v_lshlrev_b32 v30, 0x9, v30                        // 7. wave offset in M dimen: wOffset = wtid0 * W0Stride(512)
v_add_u32 v0, v30, v0                              // 7. final local read offset: flrOffset = lrOffset + WOffset
...
v_mov_b32 v30, v1                                  // copy for GlobalSplitU
/* LVCB = 4 */
...
v_mov_b32 v31, v3                                  // copy for GlobalSplitU
...
v_lshrrev_b32 v32, 7, v[vgprLocalWriteAddrB]       // padding 32 per block 128
v_lshlrev_b32 v32, 0x5, v32                        // padding 32 per block 128
v_add_u32 v[vgprLocalWriteAddrB], v32, v[vgprLocalWriteAddrB] // add padding 32 per block 128
...
v_cvt_f32_u32 v32, s48                             // s48 = s[sgprWorkGroup0] / s48
v_rcp_iflag_f32 v32, v32                           // s48 = s[sgprWorkGroup0] / s48
v_cvt_f32_u32 v33, s[sgprWorkGroup0]               // s48 = s[sgprWorkGroup0] / s48
v_mul_f32 v32, v32, v33                            // s48 = s[sgprWorkGroup0] / s48
v_cvt_u32_f32 v32, v32                             // s48 = s[sgprWorkGroup0] / s48
v_mul_u32_u24 v33, v32, s48                        // s48 = s[sgprWorkGroup0] / s48
v_sub_u32 v33, s[sgprWorkGroup0], v33              // s48 = s[sgprWorkGroup0] / s48
v_cmpx_eq_u32 exec, v33, s48                       // s48 = s[sgprWorkGroup0] / s48
v_add_u32 v32, 1, v32                              // s48 = s[sgprWorkGroup0] / s48
s_mov_b64 exec, -1                                 // s48 = s[sgprWorkGroup0] / s48
v_readfirstlane_b32 s48, v32                       // quotient
...
v_cvt_f32_u32 v32, s[sgprNumWorkGroups0]           // s48 = s[sgprWorkGroup0] / s[sgprNumWorkGroups0]
v_rcp_iflag_f32 v32, v32                           // s48 = s[sgprWorkGroup0] / s[sgprNumWorkGroups0]
v_cvt_f32_u32 v33, s[sgprWorkGroup0]               // s48 = s[sgprWorkGroup0] / s[sgprNumWorkGroups0]
v_mul_f32 v32, v32, v33                            // s48 = s[sgprWorkGroup0] / s[sgprNumWorkGroups0]
v_cvt_u32_f32 v32, v32                             // s48 = s[sgprWorkGroup0] / s[sgprNumWorkGroups0]
v_mul_u32_u24 v33, v32, s[sgprNumWorkGroups0]      // s48 = s[sgprWorkGroup0] / s[sgprNumWorkGroups0]
v_sub_u32 v33, s[sgprWorkGroup0], v33              // s48 = s[sgprWorkGroup0] / s[sgprNumWorkGroups0]
v_cmpx_eq_u32 exec, v33, s[sgprNumWorkGroups0]     // s48 = s[sgprWorkGroup0] / s[sgprNumWorkGroups0]
v_add_u32 v32, 1, v32                              // s48 = s[sgprWorkGroup0] / s[sgprNumWorkGroups0]
...
GLOBAL_OFFSET_A vgprGlobalReadOffsetA+0,  1,  0, 32 // gROA_0_0_0_0
...
GLOBAL_OFFSET_B vgprGlobalReadOffsetB+0,  3,  2, 32 // gROB_0_0_0_0

/* global read addresses: addresses a */
/* max read offset = size[n] * stride[n-1] */
s_mul_hi_u32 s71, s[sgprWorkGroup0], 32
s_mul_i32 s70, s[sgprWorkGroup0], 32
s_mul_hi_u32 s71, s70, s[sgprStrideA0I]
s_mul_i32 s70, s70, s[sgprStrideA0I]
s_and_b32 s68, s[sgprGSU], 0x8000                  // SCC = (GSUC == 1) ?
s_cbranch_scc1 label_GSUC_A                        // branch if GSUC == 1
s_mul_hi_u32 s69, 32, s[sgprGSUSumIdx]
s_mul_i32 s68, 32, s[sgprGSUSumIdx]
...
s_mul_hi_u32 s69, s68, 32
s_mul_i32 s68, s68, 32
label_GSUC_A_End:
...
s_mul_hi_u32 s69, constStrideAL, s68
s_mul_i32 s68, constStrideAL, s68
...
s_mul_hi_u32 s69, s[sgprStrideA0I], s68
s_mul_i32 s68, s[sgprStrideA0I], s68
s_add_u32 s[sgprShadowLimitA+0], s[sgprShadowLimitA+0], s68 // sum tensor size
s_addc_u32 s[sgprShadowLimitA+1], s[sgprShadowLimitA+1], s69 // sum tensor size
...
s_mul_hi_u32 s69, s[sgprStrideAK], s[sgprWorkGroup2]
s_mul_i32 s68, s[sgprStrideAK], s[sgprWorkGroup2]
...
/* max read offset = size[n] * stride[n-1] */
s_mul_hi_u32 s71, s[sgprWorkGroup1], 32
s_mul_i32 s70, s[sgprWorkGroup1], 32
s_mul_hi_u32 s71, s70, s[sgprStrideB1J]
s_mul_i32 s70, s70, s[sgprStrideB1J]
s_and_b32 s68, s[sgprGSU], 0x8000                  // SCC = (GSUC == 1) ?
...
s_sub_u32 s68, s[sgprSizeL], 1                     // (size-1)
s_mul_hi_u32 s69, constStrideBL, s68
s_mul_i32 s68, constStrideBL, s68
...
s_mul_hi_u32 s69, s[sgprStrideB1J], s68
s_mul_i32 s68, s[sgprStrideB1J], s68
s_add_u32 s[sgprShadowLimitB+0], s[sgprShadowLimitB+0], s68 // sum tensor size
s_addc_u32 s[sgprShadowLimitB+1], s[sgprShadowLimitB+1], s69 // sum tensor size
...
s_mul_hi_u32 s69, s[sgprStrideBK], s[sgprWorkGroup2]
s_mul_i32 s68, s[sgprStrideBK], s[sgprWorkGroup2]
s_add_u32 s70, s70, s68                            // accum wg term to tilestart
s_addc_u32 s71, s71, s69                           // accum wg term to tilestart
s_lshl_b64 s[70:71], s[70:71], 0x1                 // tileStart *= BPE
...
s_mul_hi_u32 s69, s70, s[sgprStrideC1J]
s_mul_i32 s68, s70, s[sgprStrideC1J]
...
s_mul_hi_u32 s69, s70, s[sgprStrideD1J]
s_mul_i32 s68, s70, s[sgprStrideD1J]
...
s_mul_hi_u32 s69, s[sgprWorkGroup2], s[sgprStrideCK]
s_mul_i32 s68, s[sgprWorkGroup2], s[sgprStrideCK]
s_lshl_b64 s[68:69], s[68:69], s[sgprGSULog2BpeC]  // scale by bpe
s_add_u32 s[sgprSrdC+0], s[sgprSrdC+0], s68        // add lo to SRD
s_addc_u32 s[sgprSrdC+1], s[sgprSrdC+1], s69       // add hi to SRD
s_mul_hi_u32 s69, s[sgprWorkGroup2], s[sgprStrideDK]
s_mul_i32 s68, s[sgprWorkGroup2], s[sgprStrideDK]
s_lshl_b64 s[68:69], s[68:69], s[sgprGSULog2BpeD]  // scale by bpe
...
s_mul_hi_u32 s69, s[sgprSizesFree+0], s[sgprGSUSumIdx]
s_mul_i32 s68, s[sgprSizesFree+0], s[sgprGSUSumIdx]
s_sub_u32 s67, s[sgprSizesFree+1], 1               // Free1
s_mul_i32 s67, s67, s[sgprGSUSumIdx]               // Free1
s_mul_hi_u32 s70, s67, s[sgprStrideC1J]
s_mul_i32 s67, s67, s[sgprStrideC1J]
...
s_mul_hi_u32 s70, s67, s[sgprStrideCK]
s_mul_i32 s67, s67, s[sgprStrideCK]
...
/* initC: remove ValuA/B vgpr buffer [0...4) from pool */
...
s_cbranch_scc0 label_NoBranch_X9GPYG2DNL3C7JQ2_0   // Only branch on scc1
...
label_NoBranch_X9GPYG2DNL3C7JQ2_0:
s_waitcnt vmcnt(2)
...
buffer_load_dwordx4 v[vgprG2LA2+4:vgprG2LA2+4+3], v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], s[sgprScalarGlobalReadOffsetA+0] offen offset:0 // G -> Reg 0_0_1_0
...
/* endSummation: add vgpr [0...29) to pool */
/* load store sgprs */
...
label_Summation_End_38NHVWF2739LUWEU_0:
/* endSummation: add vgpr [0...29) to pool */
.set sgprWGM, UNDEF
...
buffer_store_dwordx4 v[16:19], v7, s[sgprSrdD:sgprSrdD+3], 0 offen offset:64 // store D
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
...
/* (d1,vc1,d0,vc0)=(0,0,1,0) */
buffer_load_dwordx2 v[16:17], v8, s[sgprSrdC:sgprSrdC+3], 0 offen offset:32 // load C
v_add_lshl_u32 v7, v3, v0, 0x1                     // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=0, coord0Vgpr=0
v_accvgpr_read_b32 v[vgprValuC+12], acc0           // copy acc to vreg[0]
v_accvgpr_read_b32 v[vgprValuC+13], acc1           // copy acc to vreg[1]
v_accvgpr_read_b32 v[vgprValuC+14], acc2           // copy acc to vreg[2]
...
buffer_store_dwordx2 v[20:21], v7, s[sgprSrdD:sgprSrdD+3], 0 offen offset:32 // store D
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
s_branch label_GW_End_2                            // jump to end
label_GW_B1_E1:
