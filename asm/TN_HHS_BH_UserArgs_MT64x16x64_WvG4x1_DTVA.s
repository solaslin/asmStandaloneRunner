...
.text
.protected Cijk_Alik_Bljk_HHS_BH_UserArgs_MT64x16x64_MI16x16x1_SN_K1_MIWT1_1
.globl Cijk_Alik_Bljk_HHS_BH_UserArgs_MT64x16x64_MI16x16x1_SN_K1_MIWT1_1
.p2align 8
.type Cijk_Alik_Bljk_HHS_BH_UserArgs_MT64x16x64_MI16x16x1_SN_K1_MIWT1_1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Alik_Bljk_HHS_BH_UserArgs_MT64x16x64_MI16x16x1_SN_K1_MIWT1_1
...
amdhsa.version:
  ...
  - 1
amdhsa.kernels:
  - .name: Cijk_Alik_Bljk_HHS_BH_UserArgs_MT64x16x64_MI16x16x1_SN_K1_MIWT1_1
    .symbol: 'Cijk_Alik_Bljk_HHS_BH_UserArgs_MT64x16x64_MI16x16x1_SN_K1_MIWT1_1.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Cijk_Alik_Bljk_HHS_BH_UserArgs_MT64x16x64_MI16x16x1_SN_K1_MIWT1_1:
...
.macro GLOBAL_SWIZZLED_OFFSET_A vgprAddr:req vgprOffsetL:req vgprOffset0I:req vgprTmp:req
    v_mul_lo_u32 v[\vgprTmp+0] s[70] v[\vgprOffset0I] // mul d1 lower Fake strideA0I = 16x32 = 0x200
    v_add_co_u32 v[\vgprAddr+0] vcc v[\vgprOffsetL] v[\vgprTmp+0] // accumulate K lower
    v_add_u32 v[\vgprAddr+0] 0x8 v[\vgprAddr+0]      // add prepad for pointer shift
    v_lshlrev_b32 v[\vgprAddr+0] 0x1 v[\vgprAddr+0]  // offset *= bytes/element
.endm
...
// Ethan: memory is flattened, so i-offset = (wave-id * #-Kr) and stride-i = size of a flattened mem (16x32)
v_mov_b32 v6, v0                                   // groA0I_0
v_add_co_u32 v9, vcc, 1, v6                       // groA0I_0 + "One" Block of flattened mem

/* global read addresses: tile offsets b */
v_mov_b32 v7, v2                                   // groB1J_0

/* global read addresses: unroll offsets a */
// Ethan: move unroll to i-offset
v_mov_b32 v8, v1                                   // groAL_0
// v_add_co_u32 v9, vcc, 32, v8                       // groAL_1 + LSCA

/* global read addresses: unroll offsets b */
v_mov_b32 v10, v3                                  // groBL_0

/* global read addresses: final offsets a */
//GLOBAL_OFFSET_A vgprGlobalReadOffsetA+0,  8,  6, 11 // gROA_0_0_0_0
//GLOBAL_OFFSET_A vgprGlobalReadOffsetA+1,  9,  6, 11 // gROA_1_0_0_0
// Ethan: SWIZZLED: next DU: skip an I-Offset instead of unrolloffsets
s_mov_b32 s[70], 0x200 // 16x32
GLOBAL_SWIZZLED_OFFSET_A vgprGlobalReadOffsetA+0,  8,  6, 11 // gROA_0_0_0_0
GLOBAL_SWIZZLED_OFFSET_A vgprGlobalReadOffsetA+1,  8,  9, 11 // gROA_1_0_0_0
...
s_cbranch_scc0 label_NoBranch_69Y4EEBL9WGH1EYE_0   // Only branch on scc1
...
label_NoBranch_69Y4EEBL9WGH1EYE_0:
...
s_and_b32 s29, 63, s[sgprSizesSum+0]               // s29 = s[sgprSizesSum+0] % 64
...
/* endSummation: add vgpr [0...39) to pool */
/* load store sgprs */
...
label_GSUC_TL:
s_lshr_b32 s29, s[sgprSizesSum], 6                 // s29 = s[sgprSizesSum] / 64
...
/* Tail: add address/G2L vgpr [16...39) to pool */
...
v_lshlrev_b32 v16, 0x3, v16                        // v16 = v16 * 8
v_cmp_ge_i32 s[28:29], v16, s[sgprLoopCounterL]    // check K index >= Size L
...
v_cmp_lt_i32 s[28:29], v16, 4                      // set partial 0 if distance less than input per thread
...
v_lshlrev_b64 v[18:19], s30, v[vgprG2LA+0+0:vgprG2LA+0+0+1]
v_cndmask_b32 v[vgprG2LA+0+0+0], v[vgprG2LA+0+0+0], v18, s[28:29]
v_cndmask_b32 v[vgprG2LA+0+0+1], v[vgprG2LA+0+0+1], v19, s[28:29]
v_lshlrev_b64 v[18:19], s30, v[vgprValuB_X0_I0+0+0+0:vgprValuB_X0_I0+0+0+0+1]
v_cndmask_b32 v[vgprValuB_X0_I0+0+0+0+0], v[vgprValuB_X0_I0+0+0+0+0], v18, s[28:29]
v_cndmask_b32 v[vgprValuB_X0_I0+0+0+0+1], v[vgprValuB_X0_I0+0+0+0+1], v19, s[28:29]
s_nop 1
v_mfma_f32_16x16x16_f16 acc[0:3], v[vgprG2LA+0+0:vgprG2LA+0+0+1], v[vgprValuB_X0_I0+0+0+0:vgprValuB_X0_I0+0+0+0+1], acc[0:3] // left value = acc[0+0:3+0]
...
s_sub_u32 s30, 4, s30                              // use shift to fill 0 for outside element
s_lshl_b32 s30, s30, 4                             // use shift to fill 0 for outside element
v_lshlrev_b64 v[18:19], s30, v[vgprG2LA+0+2:vgprG2LA+0+2+1]
v_cndmask_b32 v[vgprG2LA+0+2+0], v[vgprG2LA+0+2+0], v18, s[28:29]
v_cndmask_b32 v[vgprG2LA+0+2+1], v[vgprG2LA+0+2+1], v19, s[28:29]
v_lshlrev_b64 v[18:19], s30, v[vgprValuB_X0_I0+0+2+0:vgprValuB_X0_I0+0+2+0+1]
v_cndmask_b32 v[vgprValuB_X0_I0+0+2+0+0], v[vgprValuB_X0_I0+0+2+0+0], v18, s[28:29]
v_cndmask_b32 v[vgprValuB_X0_I0+0+2+0+1], v[vgprValuB_X0_I0+0+2+0+1], v19, s[28:29]
s_nop 1
v_mfma_f32_16x16x16_f16 acc[0:3], v[vgprG2LA+0+2:vgprG2LA+0+2+1], v[vgprValuB_X0_I0+0+2+0:vgprValuB_X0_I0+0+2+0+1], acc[0:3] // left value = acc[0+0:3+0]
...
v_cndmask_b32 v[vgprValuB_X2_I0+0+0+0+0], v[vgprValuB_X2_I0+0+0+0+0], 0x0, s[28:29] // set 0 if K_idx >= sizeL
v_cndmask_b32 v[vgprValuB_X2_I0+0+0+0+1], v[vgprValuB_X2_I0+0+0+0+1], 0x0, s[28:29] // set 0 if K_idx >= sizeL
v_sub_u32 v16, s[sgprLoopCounterL], v16            // get distance between size and k index
v_cmp_lt_i32 s[28:29], v16, 4                      // set partial 0 if distance less than input per thread
s_and_b32 s30, s[sgprLoopCounterL], 3              // get inputs for edge thread
s_sub_u32 s30, 4, s30                              // use shift to fill 0 for outside element
s_lshl_b32 s30, s30, 4                             // use shift to fill 0 for outside element
v_lshlrev_b64 v[18:19], s30, v[vgprG2LA+4+0:vgprG2LA+4+0+1]
v_cndmask_b32 v[vgprG2LA+4+0+0], v[vgprG2LA+4+0+0], v18, s[28:29]
v_cndmask_b32 v[vgprG2LA+4+0+1], v[vgprG2LA+4+0+1], v19, s[28:29]
v_lshlrev_b64 v[18:19], s30, v[vgprValuB_X2_I0+0+0+0:vgprValuB_X2_I0+0+0+0+1]
v_cndmask_b32 v[vgprValuB_X2_I0+0+0+0+0], v[vgprValuB_X2_I0+0+0+0+0], v18, s[28:29]
v_cndmask_b32 v[vgprValuB_X2_I0+0+0+0+1], v[vgprValuB_X2_I0+0+0+0+1], v19, s[28:29]
s_nop 1
v_mfma_f32_16x16x16_f16 acc[0:3], v[vgprG2LA+4+0:vgprG2LA+4+0+1], v[vgprValuB_X2_I0+0+0+0:vgprValuB_X2_I0+0+0+0+1], acc[0:3] // left value = acc[0+0:3+0]
...
v_cndmask_b32 v[vgprValuB_X2_I0+0+2+0+0], v[vgprValuB_X2_I0+0+2+0+0], 0x0, s[28:29] // set 0 if K_idx >= sizeL
v_cndmask_b32 v[vgprValuB_X2_I0+0+2+0+1], v[vgprValuB_X2_I0+0+2+0+1], 0x0, s[28:29] // set 0 if K_idx >= sizeL
v_sub_u32 v16, s[sgprLoopCounterL], v16            // get distance between size and k index
v_cmp_lt_i32 s[28:29], v16, 4                      // set partial 0 if distance less than input per thread
s_and_b32 s30, s[sgprLoopCounterL], 3              // get inputs for edge thread
s_sub_u32 s30, 4, s30                              // use shift to fill 0 for outside element
s_lshl_b32 s30, s30, 4                             // use shift to fill 0 for outside element
v_lshlrev_b64 v[18:19], s30, v[vgprG2LA+4+2:vgprG2LA+4+2+1]
v_cndmask_b32 v[vgprG2LA+4+2+0], v[vgprG2LA+4+2+0], v18, s[28:29]
v_cndmask_b32 v[vgprG2LA+4+2+1], v[vgprG2LA+4+2+1], v19, s[28:29]
v_lshlrev_b64 v[18:19], s30, v[vgprValuB_X2_I0+0+2+0:vgprValuB_X2_I0+0+2+0+1]
v_cndmask_b32 v[vgprValuB_X2_I0+0+2+0+0], v[vgprValuB_X2_I0+0+2+0+0], v18, s[28:29]
v_cndmask_b32 v[vgprValuB_X2_I0+0+2+0+1], v[vgprValuB_X2_I0+0+2+0+1], v19, s[28:29]
s_nop 1
v_mfma_f32_16x16x16_f16 acc[0:3], v[vgprG2LA+4+2:vgprG2LA+4+2+1], v[vgprValuB_X2_I0+0+2+0:vgprValuB_X2_I0+0+2+0+1], acc[0:3] // left value = acc[0+0:3+0]
...
/* Tail: remove address/G2L [16...39) from pool */
label_Summation_End_KH4AM33B13NKQU5S_0:
/* endSummation: add vgpr [0...39) to pool */
.set sgprWGM, UNDEF
