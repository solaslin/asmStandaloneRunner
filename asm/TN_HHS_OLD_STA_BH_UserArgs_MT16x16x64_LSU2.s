...
.macro GLOBAL_OFFSET_A_SWIZZLED vgprAddr:req, vgprOffsetL:req, vgprOffset0I:req, sgprStrideSWA:req, vgprTmp:req
    v_mul_lo_u32 v[\vgprTmp+0], s[\sgprStrideSWA], v[\vgprOffset0I] // SWZ-A: mul d1 lower
    v_add_co_u32 v[\vgprAddr+0], vcc, v[\vgprOffsetL], v[\vgprTmp+0] // accumulate K lower
    v_add_u32 v[\vgprAddr+0], 0x8, v[\vgprAddr+0]      // add prepad for pointer shift
    v_lshlrev_b32 v[\vgprAddr+0], 1, v[\vgprAddr+0]    // offset *= bytes/element
.endm
...
s_lshr_b32 s67, s67, 0x5                           // SWZ-A: numKr = DimK / 32
s_mul_i32 s67, 0x1, s67                            // SWZ-A: numKr *= MI_WvG[0] (1), how many wave-M per WG

/* global read addresses: tile offsets b */
v_mov_b32 v23, v6                                  // groB1J_0

/* global read addresses: unroll offsets a */
/* SWZ-A: Unroll increament is calculated in I/J-Offset since tile-memory is flattened */
v_mov_b32 v25, v5                                  // SWZ-A: only one groAL_0 Base
...
GLOBAL_OFFSET_A_SWIZZLED vgprGlobalReadOffsetA+0, 25, 22, 67, 27 // gROA_0_0_0_0
