...
.text
.protected Cijk_Alik_Bljk_HHS_BH_UserArgs_MT32x32x32_MI16x16x1_SN_DTVA0_K1_LBSPPA128_LPA16_MIWT2_1_VWB1_WG16_8_1
.globl Cijk_Alik_Bljk_HHS_BH_UserArgs_MT32x32x32_MI16x16x1_SN_DTVA0_K1_LBSPPA128_LPA16_MIWT2_1_VWB1_WG16_8_1
.p2align 8
.type Cijk_Alik_Bljk_HHS_BH_UserArgs_MT32x32x32_MI16x16x1_SN_DTVA0_K1_LBSPPA128_LPA16_MIWT2_1_VWB1_WG16_8_1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Alik_Bljk_HHS_BH_UserArgs_MT32x32x32_MI16x16x1_SN_DTVA0_K1_LBSPPA128_LPA16_MIWT2_1_VWB1_WG16_8_1
...
amdhsa.version:
  ...
  - 1
amdhsa.kernels:
  - .name: Cijk_Alik_Bljk_HHS_BH_UserArgs_MT32x32x32_MI16x16x1_SN_DTVA0_K1_LBSPPA128_LPA16_MIWT2_1_VWB1_WG16_8_1
    .symbol: 'Cijk_Alik_Bljk_HHS_BH_UserArgs_MT32x32x32_MI16x16x1_SN_DTVA0_K1_LBSPPA128_LPA16_MIWT2_1_VWB1_WG16_8_1.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Cijk_Alik_Bljk_HHS_BH_UserArgs_MT32x32x32_MI16x16x1_SN_DTVA0_K1_LBSPPA128_LPA16_MIWT2_1_VWB1_WG16_8_1:
...
v_lshlrev_b32 v3, 0x9, v3                          // 7. wave offset in M dimen: wOffset = wtid0 * W0Stride(512)
...
v_lshlrev_b32 v3, 0x5, v3                          // Final Offset: padding 32 per block 128
v_add_u32 v[vgprLocalReadAddrA], v3, v[vgprLocalReadAddrA] // Final Offset: add padding 32 per block 128
...
v_add_u32 v[vgprLocalWriteAddrA], v6, v[vgprLocalWriteAddrA] // add padding 32 per block 128
...
s_cbranch_scc0 label_NoBranch_J5VGAJZRZXA1495P_0   // Only branch on scc1
...
label_NoBranch_J5VGAJZRZXA1495P_0:
s_waitcnt vmcnt(0)
...
/* iter 0 */
/*  grEndMfmaIndex:1, lwStartMfmaIndex:2, lwEndMfmaIndex:3  */
...
ds_read_b128 v[vgprValuA_X0_I0+4:vgprValuA_X0_I0+4+3], v[vgprLocalReadAddrA] offset:1280 // L -> Reg lro=0 swapByteOffset=0 ti=16 vIdx=1 eIdx=0 rIdx=0 oIdx=0 buffer=0 iui=0
buffer_load_dwordx4 v[vgprG2LA+0:vgprG2LA+0+3], v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], 0 offen offset:0 // G -> Reg 0_0_0_0
...
v_mfma_f32_16x16x16_f16 acc[4:7], v[vgprValuA_X0_I0+4+0+0:vgprValuA_X0_I0+4+0+0+1], v[vgprValuB_X0_I0+0+0+0:vgprValuB_X0_I0+0+0+0+1], acc[4:7] // left value = acc[4+0:7+0]
/* numPrefetchIter=0 */
...
/* localReadInitPointers */
v_mfma_f32_16x16x16_f16 acc[4:7], v[vgprValuA_X0_I0+4+2+0:vgprValuA_X0_I0+4+2+0+1], v[vgprValuB_X0_I0+0+2+0:vgprValuB_X0_I0+0+2+0+1], acc[4:7] // left value = acc[4+0:7+0]
/* numPrefetchIter=0 */
/* dataAtIterA=0 numReadsIterA=1 skipReadsIterA=0 readsPerIterA=2 */
/* dataAtIterB=0 numReadsIterB=1 skipReadsIterB=0 readsPerIterB=1 */
...
label_Summation_End_PBNPHO1YVOGIZBAR_0:
/* endSummation: add vgpr [0...26) to pool */
.set sgprWGM, UNDEF
