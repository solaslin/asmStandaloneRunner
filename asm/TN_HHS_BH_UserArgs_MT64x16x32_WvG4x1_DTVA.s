...
.text
.protected Cijk_Alik_Bljk_HHS_BH_UserArgs_MT64x16x32_MI16x16x1_SN_GRVWB2_K1_MIWT1_1_NLCA1
.globl Cijk_Alik_Bljk_HHS_BH_UserArgs_MT64x16x32_MI16x16x1_SN_GRVWB2_K1_MIWT1_1_NLCA1
.p2align 8
.type Cijk_Alik_Bljk_HHS_BH_UserArgs_MT64x16x32_MI16x16x1_SN_GRVWB2_K1_MIWT1_1_NLCA1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Alik_Bljk_HHS_BH_UserArgs_MT64x16x32_MI16x16x1_SN_GRVWB2_K1_MIWT1_1_NLCA1
...
amdhsa.version:
  ...
  - 1
amdhsa.kernels:
  - .name: Cijk_Alik_Bljk_HHS_BH_UserArgs_MT64x16x32_MI16x16x1_SN_GRVWB2_K1_MIWT1_1_NLCA1
    .symbol: 'Cijk_Alik_Bljk_HHS_BH_UserArgs_MT64x16x32_MI16x16x1_SN_GRVWB2_K1_MIWT1_1_NLCA1.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Cijk_Alik_Bljk_HHS_BH_UserArgs_MT64x16x32_MI16x16x1_SN_GRVWB2_K1_MIWT1_1_NLCA1:
...
/* Skip. 2. block offset: bnOffset = 0 when num1DBlocks = 1 */
                                                   // 4. apply VectorWidth: bnOffset = bnOffset * vw(1) (multiplier is 1, do nothing)
v_and_b32 v1, 63, v[vgprSerial]                    // 5. threLocal Read Addresses  ad id in wave: wtid = tid % wavelength(64)
v_lshrrev_b32 v1, 4, v1                            // 5. K offset: kIdx = wtid / (MIN(16) * MIBB(1))
v_lshlrev_b32 v1, 0x3, v1                          // 5. K offset: lrKOffset = kIdx * mStride(8)
v_add_u32 v0, v1, v0                               // 6. offset in wave: lrOffset = bnOffset + lrKOffset
...
s_cbranch_scc0 label_NoBranch_0REB9WETXEG91RAM_0   // Only branch on scc1
...
label_NoBranch_0REB9WETXEG91RAM_0:
...
label_Summation_End_0FTWJ29QO35CRGPL_0:
/* endSummation: add vgpr [0...22) to pool */
.set sgprWGM, UNDEF
